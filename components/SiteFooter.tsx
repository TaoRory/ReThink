        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-pearl-100/70">
              <li><Link className="hover:text-pearl-100" href="/about">Về ReThink</Link></li>
              <li><Link className="hover:text-pearl-100" href="/tedx">TEDxVinUniversity</Link></li>
              <li><Link className="hover:text-pearl-100" href="/join">Tuyển thành viên Gen 5</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-pearl-100/70">
              ...
              <li className="text-pearl-100/45">VinUniversity, Gia Lâm, Hà Nội</li>
            </ul>
          </div>
        </div>
